...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, @required this.peerId, @required this.peerAvatar,this.friendName}) : super(key: key);
              ...
              children: <Widget>[
                document['type'] == 0
                    ...
                    ? Container(
                        child: Text(
                          document['content'],
                          style: TextStyle(color: Colors.blueGrey,fontSize: _width*0.035),
                        ),
                        padding: EdgeInsets.fromLTRB(15.0, 10.0, 15.0, 10.0),
                        width: _width*0.5,
                        decoration: BoxDecoration(color: Color(0xFFF9edec), borderRadius: BorderRadius.circular(8.0)),
                ...
                document['type'] == 0
                    ? Padding(
                      ...
                      child: Container(
                          ...
                          padding: EdgeInsets.fromLTRB(15.0, 10.0, 15.0, 10.0),
                          width: _width*0.5,
                          decoration: BoxDecoration(color: Color(0xFFffcdcd), borderRadius: BorderRadius.circular(8.0)),

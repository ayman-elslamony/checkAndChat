...
import 'package:checkandchat/chats/widgets/full_photo.dart';
...
class FriendChatScreen extends StatefulWidget {
  ...
  FriendChatScreen({Key key, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => FriendChatScreenState(peerId: peerId, peerAvatar: peerAvatar);
}

class FriendChatScreenState extends State<FriendChatScreen> {
  FriendChatScreenState({Key key, @required this.peerId, @required this.peerAvatar});
...
//          .collection('chat')
//          .document(widget.peerId).get().then((value){
//        print('B');
//        if(!value.exists){
          print('C');
          Firestore.instance
              ...
              .document(currentUserId)
              .collection('chat')
              .document(widget.peerId).setData({

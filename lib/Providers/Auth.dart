...
class Auth with ChangeNotifier {
  ...
  Future<bool> getLocation() async {
    ...
    try {
      ...
      if (!prefs.containsKey('userLocation')) {
        ...
        print('else');
        final userLocation = await json.decode(prefs.getString('userLocation'))
    ...
    if (prefs.containsKey('signInUsingEmail')) {
      ...
      await firebaseAuth
          .signInWithEmailAndPassword(
              email: dataToSignIn['email'], password: dataToSignIn['password'])
          .then((_) {
  ...
  Future<bool> signUpUsingEmail(
      {String name, String imgUrl, String email, String password}) async {
    try {
